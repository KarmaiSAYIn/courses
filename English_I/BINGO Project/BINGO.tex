...
\begin{enumerate}
    ...
    \item{Romeo's Dagger:}
        ...
        While only a few characters (Romeo, Juliet, Lord Capulet, Peter, and two extra musicians) ever interact with a dagger, whether verbally or 
            physically, it's purpose is definite as it's use regarding Juliet.
    \item{Rope Ladder:}
        \begin{center}
    ...
    \item{Herbs and Flowers:}
        ...
        In this aforementioned scene, Friar Lawrence describes both ``man as well as herbs'' as being ``naught so vile'' as well as ``Nor aught so good,'' describing the struggle of good and evil with humans; the metatphor relating to the properties of 
    ...
    \item{Juliet's Necklace:}
        ...
        \end{center}
        \paragraph~
        My reason for this choice is rather dense; it boils down to a peice of jewlery that isn't exaclt referenced in the play, but is referenced in the movie (\href{https://www.boxofficemojo.com/release/rl2305590785/weekend/}{Romeo + Juliet}).
