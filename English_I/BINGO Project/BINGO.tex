...
These are eight artifacts that I believe to be essential to the plot of Romeo and Juliet; along with a brief explanation of each.
\begin{enumerate}
    \item{Letter:}\label{letter_to_romeo}
        \begin{center}
            %\includegraphics[max width=\textwidth - 6ex]{pics/letter_to_romeo.jpg}
            \includegraphics[max width=\textwidth - 6ex]{pics/dunce.jpg}
        \end{center}
        \paragraph~
    ...
    \item{Sword:}
        ...
        \end{center}
        \paragraph~
        Use of swords is a major writing point in Romeo and Juliet owing to the time of it's inscription; sword-play made the heart of any sort of combat, with several manipulations of them, as devices, spaced throughout the play.
        Two examples of these aforementioned manipulations are in Act I Scene I in which the Montague and Capulet feud is introduced through the drawing of several swords during an altercation;
            another is the fight between Tybalt and Romeo; the latter being pertinent to my choice of this item.
        The fight between 
    \item{Rope Ladder:}
        \begin{center}
    ...
    \item{{\color{blue}\underline{\href{https://www.youtube.com/watch?v=73lj5qJbrms}{All Together Now}}}:}
        \begin{center}
            \includegraphics[max width=\textwidth - 6ex]{pics/all_together_now.jpg}
        \end{center}
\end{enumerate}
